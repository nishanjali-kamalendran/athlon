        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              <a href="https://www.instagram.com/athlon.app?igsh=MWM5MG9vaGNwMWxrcQ==" className="social-link" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/company/107130259/admin/dashboard/" className="social-link" aria-label="LinkedIn">
                <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="copyright">
              © 2025 Athlon. All rights reserved.
            </p>
